        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-4 mb-6">
              <img src="/logo.png" alt="AbsolutData Ltd Logo" className="h-12 w-12 object-contain mix-blend-screen opacity-90" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/privacy" className="text-[var(--color-text-muted)] hover:text-white transition-colors">Privacy Policy</Link></li>
              <li><Link to="/terms" className="text-[var(--color-text-muted)] hover:text-white transition-colors">Terms & Conditions</Link></li>
              <li><Link to="/imprint" className="text-[var(--color-text-muted)] hover:text-white transition-colors">Imprint</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-[var(--color-text-muted)]">
                ...
                <span className="text-sm">8 Clermont Place<br />Romford, RM1 2EY<br />United Kingdom</span>
              </li>
              <li className="flex items-center gap-3 text-[var(--color-text-muted)]">
                <Phone size={20} className="text-[var(--color-primary)] shrink-0" />
                <a href="tel:+447535975867" className="text-sm hover:text-[var(--color-primary)] transition-colors">+44 7535 975867</a>
              </li>
              <li className="flex items-center gap-3 text-[var(--color-text-muted)]">
                <Mail size={20} className="text-[var(--color-primary)] shrink-0" />
                <a href="mailto:tasnim.kumar@hotmail.com" className="text-sm hover:text-[var(--color-primary)] transition-colors">tasnim.kumar@hotmail.com</a>
              </li>
            </ul>
          </div>
